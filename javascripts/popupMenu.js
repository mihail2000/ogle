define (['canvasUtil'], function(canvasUtil) {
   ...
   * selectionListener
   *
   * This method should be called whenever touch or mouseclick event occurrs on the canvas displaying the popup menu.
   * The function decides which item from the popup was clicked and fires callback event with the selected item ID.
   */
  function selectionListener(x, y) {
    if (popupMenuLayer != null && visible) {
   ...
   *
   * Parameters:
   *  menuLayer - KineticJS layer, which is used to display the popup menu.
   */
